  ...
  return (
    <main>
      ...
      <div className="flex flex-col">
        <Navbar />
        {/* <div className="mt-32 mb-24 xl:max-w-5-1xl max-w-index w-10/12 mx-auto text-white flex flex-wrap xl:justify-between justify-center">         
        ...
        <div className="w-full flex justify-center items-center text-blue-underline absolute top-1/2 transform -translate-y-full">
          <p className="md:text-6xl text-5xl max-sm:text-2xl font-bold">Coming soon ...</p>
        </div>
        <Footer isContentEmpty />
      </div>
    </main>
  )
}
